...
- have basic understanding of work with `bitcoin-cli`
...
It's time we solve the stupid simple equation and get our sats back. Our locking script hold the equation and in our unlocking script we must provide the value to solve the equation. Solution so solve the equation is `8`:
...
+----------+-------+
| OP_ADD   |  04   |
| 12       |  04   | another 4 gets added to the stack
| OP_EQUAL |       |
+----------+-------+
...
+----------+-------+
| OP_ADD   |  08   |
| 12       |  04   | 4 gets added to the stack
| OP_EQUAL |       |
+----------+-------+
